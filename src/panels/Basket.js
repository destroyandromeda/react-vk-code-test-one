...
const Basket = ({match: {params: {areaId, itemId}}, foodAreas, order}) => {
    const [faster, setFaster] = useState(eval(localStorage.fast));
    const [time, setTime] = useState(localStorage.time);
    const [selfService, setSelfService] = useState(!eval(localStorage.self));
                ...
                <div className="Place__choice-item">
                    ...
                    <Checkbox
                        ...
                        onToggle={() => {
                            if (faster) {
                                setFaster(false);
                                localStorage.fast = false
                            } else {
                                setTime('');
                                setFaster(true);
                                localStorage.fast = true
                            }
                        }}
                    />
                </div>
                <div className="Place__choice-item">
                    ...
                    <input
                        ...
                        onChange={event => {
                            ...
                            localStorage.time = event.target.value
